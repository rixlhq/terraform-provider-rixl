		...
		Attributes: map[string]schema.Attribute{
			...
			"policies": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					...
					CustomType: PoliciesDataSourceType{
						ObjectType: types.ObjectType{
							AttrTypes: PoliciesDataSourceValue{}.AttributeTypes(ctx),
						},
					},
				},
				Computed: true,
...
var _ basetypes.ObjectTypable = PoliciesDataSourceType{}

type PoliciesDataSourceType struct {
	basetypes.ObjectType
}

func (t PoliciesDataSourceType) Equal(o attr.Type) bool {
	other, ok := o.(PoliciesDataSourceType)
...
func (t PoliciesDataSourceType) String() string {
	return "PoliciesType"
}

func (t PoliciesDataSourceType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	return PoliciesDataSourceValue{
...
func NewPoliciesDataSourceValueNull() PoliciesDataSourceValue {
	return PoliciesDataSourceValue{
		state: attr.ValueStateNull,
	}
}

func NewPoliciesDataSourceValueUnknown() PoliciesDataSourceValue {
	return PoliciesDataSourceValue{
		state: attr.ValueStateUnknown,
	}
}

func NewPoliciesDataSourceValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (PoliciesDataSourceValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if diags.HasError() {
		return NewPoliciesDataSourceValueUnknown(), diags
	}
...
func NewPoliciesDataSourceValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) PoliciesDataSourceValue {
	object, diags := NewPoliciesDataSourceValue(attributeTypes, attributes)
...
func (t PoliciesDataSourceType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewPoliciesDataSourceValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewPoliciesDataSourceValueUnknown(), nil
	}
	...
	return NewPoliciesDataSourceValueMust(PoliciesDataSourceValue{}.AttributeTypes(ctx), attributes), nil
}

func (t PoliciesDataSourceType) ValueType(ctx context.Context) attr.Value {
	return PoliciesDataSourceValue{}
}

var _ basetypes.ObjectValuable = PoliciesDataSourceValue{}

type PoliciesDataSourceValue struct {
...
func (v PoliciesDataSourceValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
...
func (v PoliciesDataSourceValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v PoliciesDataSourceValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v PoliciesDataSourceValue) String() string {
	return "PoliciesValue"
}

func (v PoliciesDataSourceValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v PoliciesDataSourceValue) Equal(o attr.Value) bool {
	other, ok := o.(PoliciesDataSourceValue)
...
func (v PoliciesDataSourceValue) Type(ctx context.Context) attr.Type {
	return PoliciesDataSourceType{
		basetypes.ObjectType{
...
func (v PoliciesDataSourceValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
