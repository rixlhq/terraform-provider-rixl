...
func BillingSubscriptionDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"query_org_id": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "",
				MarkdownDescription: "",
...
type BillingSubscriptionModel struct {
	...
	QueryOrgId        types.String `tfsdk:"query_org_id"`
