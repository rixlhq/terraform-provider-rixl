...
RESOURCE_META: dict[str, dict] = {
    ...
    "payment_method": {
        ...
        "create_keep_path_keys": [],
        "update_keep_path_keys": [],
        "body_renames": {"provider_name": "provider"},
        "computed_body_keys": ["id", "type", "provider_name", "details", "is_default", "brand", "last4", "exp_month", "exp_year", "created_at"],
        "create_response_field": "",
    ...
    "auth_provider_connection": {
        "create_method": "ConnectProvider",
        "read_method": "ListProviders",
        "delete_method": "DisconnectProvider",
        "path_params": [],
        "delete_path_params": ["id"],
        "create_keep_path_keys": [],
        "update_keep_path_keys": [],
        "body_renames": {"id": "provider"},
        "computed_body_keys": ["username", "first_name", "last_name", "email_address", "image_url"],
        "create_response_field": "",
        "read_list_field": "providers",
        "read_list_id_field": "id",
        "read_after_create": True,
        "read_after_update": False,
    },
